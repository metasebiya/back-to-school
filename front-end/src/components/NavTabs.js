...
const useStyles = ((theme) => ({
    ...
    LogoTextNavbar:{
        display:'block', textDecoration:'none', color:'inherit',wordSpacing:'2px'
    }
        ...
        if (this.props.getToken()) {
            return (
                <React.Fragment>
                    ...
                    <ListItem><Button href={process.env.PUBLIC_URL + '/addevent'}>AddEvent</Button></ListItem>
            ...
            return (
                <React.Fragment>
                    ...
                    <ListItem><Button href={process.env.PUBLIC_URL + '/sideEvent'}>Side Event </Button></ListItem>
                    <ListItem><Button href={process.env.PUBLIC_URL + '/about'}>About</Button></ListItem>
                    <ListItem><Button href={process.env.PUBLIC_URL + '/exhibitor'}>Exhibitor</Button></ListItem>
                    ...
                    <ListItem><Button href={process.env.PUBLIC_URL + '/signup'}>Register</Button></ListItem>
                </React.Fragment>
            )
        }
    };
        ...
        if (isWidthDown('sm', this.props.width)) {
            if (this.state.isHumActive) {
                        ...
                        <div style={{display:"flex", justifyContent:'space-between',}}>
                            <div>
                                <h3 style={{fontSize: '30px', margin: 0, color: 'black'}}>
                                    <a href={'/'} className={classes.LogoTextNavbar}>
                                        <span style={{color: '#ee662d'}}>Back</span> to School Ethiopia Expo </a></h3>
                            </div>
                ...
                return (
                    ...
                    <div style={{
                        ...
                        <div>
                            <h3 style={{fontSize: '30px', margin: 0, color: 'black'}}><a href={'/'} className={classes.LogoTextNavbar}>
            ...
            return (
                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap'}}>
                    <div>
                        <div>
                            <h3 style={{fontSize: '30px', margin: 0, color: 'black'}}><a className={classes.LogoTextNavbar}  href={'/'}>
